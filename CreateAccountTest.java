...
public class CreateAccountTest {
	...
	public static void testng() throws InterruptedException,
		...
		driver.findElement(
				...
				.click();
		driver.findElement(By.xpath("//*[@id='acc2']")).sendKeys("Automated Account 11");
		...
		String str = driver.findElement(By.xpath("//*[@id='pg:j_id1:pgMsg:j_id2:j_id3:0:j_id4:j_id5:j_id7']"))
				.getText();
		//verifying the result
		assertEquals(str, "Your Salesforce Account has been created successfully in DSM.");
